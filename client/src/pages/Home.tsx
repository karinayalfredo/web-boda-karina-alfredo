...
import { MapPin, Calendar, Clock, Heart, Copy, Phone, Info } from "lucide-react";
...
function Hero() {
  ...
  const portadaSrc = `${import.meta.env.BASE_URL}portada.jpg`;
      ...
      <div className="relative z-20 text-center text-white px-4 max-w-4xl mx-auto space-y-8 animate-in fade-in zoom-in duration-1000">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-white/90 max-w-lg mx-auto text-lg leading-relaxed mt-4">
            Nos casamos y queremos compartir contigo este día tan especial y lleno de
            amor.
          </p>
        </div>
...
function Gallery() {
  const images = [
    `${import.meta.env.BASE_URL}foto1.jpg`,
    `${import.meta.env.BASE_URL}foto2.jpg`,
    `${import.meta.env.BASE_URL}foto3.jpg`,
    `${import.meta.env.BASE_URL}foto4.jpg`,
  ];
      ...
      <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
        ...
        >
          ...
          <div className="pt-4 border-t border-border">
            <p className="font-medium text-lg text-foreground mb-1">
            ...
            <Button
              ...
              onClick={() =>
                window.open(
                  "https://www.google.com/maps/search/?api=1&query=Monasterio+de+El+Paular+Rascafria",
                  "_blank",
                )
              }
            >
        ...
        >
          <div className="w-16 h-16 bg-primary/10 text-primary rounded-full flex items-center justify-center mx-auto mb-4">
            <img
              src="https://em-content.zobj.net/source/microsoft-teams/337/clinking-glasses_1f942.png"
              alt="Cheers"
          ...
          <div className="pt-4 border-t border-border">
            ...
            <Button
              ...
              onClick={() =>
                window.open(
                  "https://www.google.com/maps/search/?api=1&query=Finca+El+Robledo+Rascafria",
                  "_blank",
                )
              }
            >
            ...
            {activities.map((activity, i) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground uppercase tracking-wider text-xs font-semibold">
                    {activity.type}
                  </p>
                </div>
              </div>
    ...
    <section id="gift" className="section-padding bg-primary text-primary-foreground relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto text-center relative z-10 space-y-8">
        <p className="text-lg md:text-xl text-primary-foreground/90 leading-relaxed">
          Vuestra presencia es nuestro mayor regalo. No obstante, si queréis ayudarnos a empezar
          esta nueva etapa o contribuir a nuestra luna de miel, podéis hacerlo aquí:
        </p>
  ...
  const faqs = [
    {
      ...
      a: "Por favor, confirma tu asistencia antes del 4 de mayo de 2026 para que podamos organizar todo perfectamente.",
    },
    {
      q: "¿Hay opciones vegetarianas o para alergias?",
      a: "¡Sí! En el formulario de confirmación encontrarás un apartado para indicarnos cualquier alergia o preferencia alimentaria.",
    },
    {
      q: "¿Cómo funciona el transporte?",
      a: "Estamos organizando transporte desde Madrid hasta el Monasterio y la Finca. Habrá un autobús de vuelta a Madrid al cierre de la finca. Más adelante compartiremos horarios y puntos de recogida.",
    },
    {
      q: "¿Qué pasa si llego tarde?",
      a: "Te recomendamos llegar 15 minutos antes de la ceremonia. Si llegas tarde, por favor espera discretamente en la entrada hasta que el personal te indique.",
    },
    {
      q: "¿A quién contacto si tengo más dudas?",
      a: "Puedes escribirnos por WhatsApp o llamarnos a los números que encontrarás más abajo.",
    },
  ];
